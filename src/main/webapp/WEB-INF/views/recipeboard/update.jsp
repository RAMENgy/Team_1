...
<head>
    ...
    <title>${rbDTO.subject } : 오늘 뭐 먹지?</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    <div class="row container">
                    	<!-- 글쓰기 영역 시작 -->
                    	<form action="${pageContext.request.contextPath }/recipeboard/updatePro" method="post" enctype="multipart/form-data">
						<input type="hidden" name="id" value="${rbDTO.id }">
						...
						<tr><td>제목</td>
						    <td><input class="form-control" type="text" id="subject" name="subject" value="${rbDTO.subject }"></td></tr>
						<tr><td>내용</td>
						    <td><div class="full-height form-control" id='image_preview' contentEditable="true">
						    		<div id='att_zone' data-placeholder='레시피 수정시 이미지도 재첨부 해야합니다.'></div>
						    		<div>
						    		<textarea class="form-control" id="content" name="content" cols="70" rows="10">${rbDTO.content }</textarea>
						    		</div>
						    	</div>
						    	</td></tr>
						</table>
