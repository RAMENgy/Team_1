...
<form action="${pageContext.request.contextPath }/notice/updatePro" method="post">
	...
	<table class="table table-hover" style="text-align: center;">
    	...
    	<thead>
			...
			<tr><td>내용</td>
    			<td><textarea name="content" rows="10" cols="60" class="form-control">${noticeDTO.content }</textarea></td></tr>
   		</thead>
	</table>  
...
<input type="button" value="글목록" class="btn" onclick="location.href='${pageContext.request.contextPath }/notice/list'">
</div>
</form>
